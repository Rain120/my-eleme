  ...
  <div>
    <div class="goods">
      ...
      <div class="foods-wrapper" ref="foodsWrapper">
        <ul>
          <li class="food-list" ref="foodList" v-for="(item, listIndex) in goods" :key="listIndex">
            <h1 class="title"> {{ item.name }} </h1>
            <ul>
              <li @click="selectFood(food, $event)" class="food-item border-1px" v-for="(food, foodIndex) in item.foods" :key="foodIndex">
                <div class="icon">
